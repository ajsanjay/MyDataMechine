...
struct AlertContext {
    ...
    static let PageCountGreaterthan1 = AlertItem(title: Text("Cannot proceed this count"), message: Text("Please input a count greater or equal to 1"), dismissButton: .default(Text("Ok")))
